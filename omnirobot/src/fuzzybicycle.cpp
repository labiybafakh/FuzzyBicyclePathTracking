...
// void pathCallback(const std_msgs::Int8::ConstPtr& datapath){
// 	modepath = datapath->data;
// }
...
void chatterCallback(const geometry_msgs::TransformStamped::ConstPtr& msg)
{
  ...
  PosY  += (TempY * tcos) - (TempX * tsin);
  	...
  	printf("\nXP: %.2f\tYP: %.2f\tTheta: %.2f\tPosX: %.2f\tPosY: %.2f",xp,yp,Theta,PosX,PosY);
...
void RfuzzyCallback(const std_msgs::Int32::ConstPtr& dataR){
	Rfuzzy = dataR->data;
}

void VfuzzyCallback(const std_msgs::Int32::ConstPtr& dataV){
	Vfuzzy = dataV->data;
}
...
void ModePath3(){
	...
	if(runqueue==1){
		FuzzyBP(300,200,90,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==2){
		FuzzyBP(300,300,90,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	...
	if(runqueue==7){
		FuzzyBP(300,400,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}	
	if(runqueue==8){
		FuzzyBP(200,400,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==9){
		FuzzyBP(100,600,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
}
...
void ModePath2(){
	...
	if(runqueue==1){
		FuzzyBP(100,300,90,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==2){
		FuzzyBP(100,400,90,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	...
	if(runqueue==7){
		FuzzyBP(300,200,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}	
	if(runqueue==8){
		FuzzyBP(200,200,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==9){
...
void ModePath1(){
	...
	if(runqueue==8){
		FuzzyBP(350,200,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==9){
		FuzzyBP(150,100,10,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
}
...
void Path1(){
	if(runqueue==0){
		bicycle_path(0,100,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==1){
		bicycle_path(-50,200,90,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==2){
		bicycle_path(-100,50,90,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==3){
		bicycle_path(-150,200,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==4){
		bicycle_path(-100,350,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==5){
		bicycle_path(0,300,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==6){
		bicycle_path(50,350,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==7){
		bicycle_path(100,300,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}	
	if(runqueue==8){
		bicycle_path(50,200,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==9){
		bicycle_path(100,100,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
}
...
void Path2(){
	if(runqueue==0){
		bicycle_path(100,50,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==1){
		bicycle_path(150,500,90,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==2){
		bicycle_path(50,400,90,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==3){
		bicycle_path(50,100,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==4){
		bicycle_path(-50,50,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==5){
	...
	if(runqueue==6){
		bicycle_path(-150,400,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==7){
		bicycle_path(-100,500,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}	
	if(runqueue==8){
		bicycle_path(0,600,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==9){
		bicycle_path(-50,300,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
...
void Path3(){
	if(runqueue==0){
		bicycle_path(-100,100,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==1){
		bicycle_path(-150,250,90,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==2){
		bicycle_path(-200,600,90,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==3){
		bicycle_path(-50,500,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==4){
	...
	if(runqueue==5){
		bicycle_path(100,500,0,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==6){
	...
	if(runqueue==7){
		bicycle_path(100,250,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}	
	if(runqueue==8){
		bicycle_path(200,50,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
	if(runqueue==9){
		bicycle_path(100,50,10,300,R,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
}
...
void Path3Fuzzy(){
	...
	if(runqueue==1){
		FuzzyBP(-150,250,90,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}

	if(runqueue==2){
		FuzzyBP(-200,600,90,2);
		if(flagrun==1){flags=0;runqueue++;}
		else flags=1;
	}
...
//  ros::NodeHandle handleOdo;

//   ros::Subscriber sub_path = handleOdo.subscribe("path",1000,pathCallback);
//   ros::Publisher odom_pub = handleOdo.advertise<nav_msgs::Odometry>("posisi",1000);
  ros::Subscriber sub = n.subscribe("odom", 1000, chatterCallback);
  ros::Subscriber sub_imu = n.subscribe("imu",100,imuCallback);
  ros::Subscriber sub_vfuzzy = fuzzy.subscribe("Vfuzzy",100,VfuzzyCallback);
  ros::Subscriber sub_rfuzzy = fuzzy.subscribe("Rfuzzy",100,RfuzzyCallback);
  ros::Publisher ErDistance_pub = fuzzy.advertise<std_msgs::Int32>("ErDistance",100);
  ros::Publisher ErPath_pub = fuzzy.advertise<std_msgs::Int32>("ErPath",100);
  ...
  while(ros::ok){
	...
	//ModePath2();
	Path2Fuzzy();
	// if(modepath == 1) ModePath1();
	// else if(modepath == 2) ModePath2();
	// else if(modepath == 3) ModePath3();
	...
	data1.data = target_distance;
	data2.data = erorjalur;
	
	ErDistance_pub.publish(data1);
	ErPath_pub.publish(data2);
